package com.compose.mvvm.ui.auth
...
import com.compose.mvvm.theme.MvvmComposeAppTheme
import com.compose.mvvm.theme.colorPrimary
import com.compose.mvvm.theme.dark_gray
import com.compose.mvvm.theme.ghost_white
import com.compose.mvvm.theme.gray
import com.compose.mvvm.theme.light_gray
            ...
            item {
                ConstraintLayout {
                    ...
                    Card(
                        ...
                        Column(
                            modifier = Modifier.background(ghost_white)
                                .fillMaxSize()
                                .padding(30.dp)
                        ) {
                            ...
                            CustomStyleTextField(
                                "Email Address",
                                com.compose.mvvm.R.drawable.ic_email,
                                KeyboardType.Email,
                            ...
                            CustomStyleTextField(
                                "Password",
                                com.compose.mvvm.R.drawable.ic_password,
...
fun HeaderView() {
    Image(
        modifier = Modifier.fillMaxSize(),
        bitmap = ImageBitmap.imageResource(id = R.drawable.ic_splash_logo),
    ...
    Column(
        ...
        Image(
            modifier = Modifier.wrapContentWidth(),
            bitmap = ImageBitmap.imageResource(id = R.drawable.ic_app_logo),
        ...
        Text(
            ...
            style = TextStyle(
                fontSize = 40.sp,
                fontFamily = FontFamily(Font(com.compose.mvvm.R.font.josefin_sans_semibold_italic)),
                letterSpacing = 2.sp
            )
        )
    }
